...
<div class="container my-5">
    <h1 class="text-center mb-4">Featured Apartments</h1>
    <div class="row">
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card">
                <img src="images/villa1.jpg" class="card-img-top" alt="Villa 1">
                <div class="card-body">
                    <h5 class="card-title">Apartment One</h5>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Apartment Two</h5>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Apartment Three</h5>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Apartment Four</h5>
